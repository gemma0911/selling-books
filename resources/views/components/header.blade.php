...
<div class="super_container">
    <header class="header">
                    ...
                    <div class="col d-flex flex-row">
                        ...
                        <div class="top_bar_content ml-auto">
                            ...
                            <div class="top_bar_user">
                                ...
                                <div><a href="{{ route('register.get')}}">Register</a></div>
        ...
        <div class="header_main ">
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-sm-1 col-3 order-1">
                        <div class="logo_container">
                            <div class="logo"><a href="#">SHOPBOOK</a></div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-12 order-lg-2 order-3 text-lg-center text-right">
